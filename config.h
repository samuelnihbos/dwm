...
static const char *fonts[]          = { "SFMono Nerd Font:size=13", "fontawesome:size=12" };
static const char dmenufont[]       = "monospace:size=11";
//background color
static const char col_gray1[]       = "#181b21";
...
static const char *screenshot[] = { "dm-maim", NULL};
#include "shiftview.c"

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY|ShiftMask,             XK_d,      spawn,          SHCMD("dmenu_run -i -c -l 20 -p 'Run:'")},
    ...
    { MODKEY,                       XK_d,      spawn,          SHCMD("dm-confedit") },
